...
export class UserProfileComponent implements OnInit {
  ...
  //           this.registerService.openSnackBar('The image dimensions exceed the allowed limits. Please upload an image with a width of 310 pixels and a height of 325 pixels.', 'Close');
  //         } else {
        ...
        reader.onload = (e: any) => {
            ...
            img.onload = () => {
                if (img.width === 310 && img.height === 325) {
                    ...
                    this.registerService.openSnackBar('Please upload an image with a width of 310 pixels and a height of 325 pixels.', 'Close');
                }
            };
        };
